...
void interrupt_at_low_vector(void) { _asm GOTO isr_low _endasm }
...
void init() {
  ...
  // Sensor 0 timer
  OpenTimer0(TIMER_INT_OFF & T0_16BIT & T0_PS_1_2 & T0_SOURCE_INT);
...
void init_app_eeprom(void) {
  ...
  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL1,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL2,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL3,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL4,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL5,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL6,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);

  writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL7,
              RELAY_CONTROLBIT_ONEVENT | RELAY_CONTROLBIT_OFFEVENT |
                  RELAY_CONTROLBIT_ENABLED);
...
void doApplicationOneSecondWork(void) {
  ...
  for (i = 0; i < 8; i++) {
    ...
    if (!(ctrlreg & RELAY_CONTROLBIT_ENABLED))
      continue;
    ...
    if (relay_protection_timer[i]) {
      ...
      if (!relay_protection_timer[i] &&
          (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0 + i) &
    ...
    if (relay_pulse_flags & (1 << i)) {
      ...
      if (relay_pulse_timer[i]) {
        ...
        if (!relay_pulse_timer[i]) {
          ...
          // Reload timer
          relay_pulse_timer[i] =
              readEEPROM(VSCP_EEPROM_END + REG_RELAY_PULSE_TIME_MSB0 + 2 * i) *
                  256 +
...
unsigned char getMajorVersion() { return FIRMWARE_MAJOR_VERSION; }

///////////////////////////////////////////////////////////////////////////////
// Get Minor version number for this hardware module
//

unsigned char getMinorVersion() { return FIRMWARE_MINOR_VERSION; }

///////////////////////////////////////////////////////////////////////////////
// Get Subminor version number for this hardware module
//

unsigned char getSubMinorVersion() { return FIRMWARE_SUB_MINOR_VERSION; }
...
unsigned char getBootLoaderAlgorithm(void) { return VSCP_BOOTLOADER_PIC1; }
...
uint8_t vscp_getZone(void) { return readEEPROM(VSCP_EEPROM_END + EEPROM_ZONE); }
...
uint8_t vscp_writeAppReg(uint8_t reg, uint8_t val) {
  ...
  if ((reg >= 2) && (reg < 10)) {
    ...
    if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0 + reg - 2) &
        RELAY_CONTROLBIT_ENABLED) {
      ...
      case REG_RELAY_STATE0:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[0] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB0) *
                    256 +
      ...
      case REG_RELAY_STATE1:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL1) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[1] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB1) *
                    256 +
      ...
      case REG_RELAY_STATE2:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL2) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[2] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB2) *
                    256 +
      ...
      case REG_RELAY_STATE3:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL3) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[3] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB3) *
                    256 +
      ...
      case REG_RELAY_STATE4:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL4) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[4] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB4) *
                    256 +
      ...
      case REG_RELAY_STATE5:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL5) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[5] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB5) *
                    256 +
      ...
      case REG_RELAY_STATE6:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL6) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[6] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB6) *
                    256 +
      ...
      case REG_RELAY_STATE7:
        ...
        if (1 == val) {
          ...
          if (readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL7) &
              RELAY_CONTROLBIT_PROTECTION) {
            relay_protection_timer[7] =
                readEEPROM(VSCP_EEPROM_END + REG_RELAY_PROTECTION_TIME_MSB7) *
                    256 +
  ...
  if (bInfoEvent) {
    ...
    if (bOn) {
      ...
      if (val & RELAY_CONTROLBIT_ONEVENT) {
        SendInformationEvent(reg - 2, VSCP_CLASS1_INFORMATION,
                             VSCP_TYPE_INFORMATION_ON);
      }
...
void SendInformationEvent(unsigned char idx, unsigned char eventClass,
  ...
  for (i = 0; i < DESCION_MATRIX_ELEMENTS; i++) {
    ...
    if (dmflags & VSCP_DM_FLAG_ENABLED) {
      ...
      if ((dmflags & VSCP_DM_FLAG_CHECK_OADDR) &&
          (vscp_imsg.oaddr !=
           readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX + (8 * i)))) {
        continue;
      }
      ...
      type_filter = readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX + (8 * i) +
                               VSCP_DM_POS_TYPEFILTER);
      type_mask = readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX + (8 * i) +
      ...
      if (!((class_filter ^ vscp_imsg.class) & class_mask) &&
        ...
        switch (readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX + (8 * i) +
                           VSCP_DM_POS_ACTION)) {

        case ACTION_ON: // Enable relays in arg. bitarry
          doActionOn(dmflags, readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                         (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;

        case ACTION_OFF: // Disable relays in arg. bitarry
          doActionOff(dmflags, readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                          (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;

        case ACTION_PULSE: // Pulse relays in arg. bitarry, zone, subzone
          doActionPulse(dmflags,
                        readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                   (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;

        case ACTION_STATUS: // Send status for all relays
          doActionStatus(dmflags,
                         readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                    (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;

        case ACTION_DISABLE: // Disable realys in bitarray
          doActionDisable(dmflags,
                          readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                     (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;

        case ACTION_TOGGLE: // Toggle relay(s)
          doActionToggle(dmflags,
                         readEEPROM(VSCP_EEPROM_END + REG_DESCION_MATRIX +
                                    (8 * i) + VSCP_DM_POS_ACTIONPARAM));
          break;
...
void doActionOn(unsigned char dmflags, unsigned char arg) {
  ...
  for (i = 0; i < 8; i++) {
    ...
    if (dmflags & VSCP_DM_FLAG_CHECK_SUBZONE) {
      if (vscp_imsg.data[2] !=
          readEEPROM(VSCP_EEPROM_END + REG_RELAY1_SUBZONE + i)) {
        continue;
      }
    }
    ...
    if (!(val & RELAY_CONTROLBIT_ENABLED))
      continue;
...
void doActionDisable(unsigned char dmflags, unsigned char arg) {
  ...
  for (i = 0; i < 8; i++) {
    ...
    val = readEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0 + i);
    writeEEPROM(VSCP_EEPROM_END + REG_RELAY_CONTROL0 + i,
                val & ~RELAY_CONTROLBIT_ENABLED);
  }
}
...
unsigned char vscp_getMajorVersion() { return FIRMWARE_MAJOR_VERSION; }

///////////////////////////////////////////////////////////////////////////////
// Get Minor version number for this hardware module
//

unsigned char vscp_getMinorVersion() { return FIRMWARE_MINOR_VERSION; }

///////////////////////////////////////////////////////////////////////////////
// Get Subminor version number for this hardware module
//

unsigned char vscp_getSubMinorVersion() { return FIRMWARE_SUB_MINOR_VERSION; }
...
uint8_t vscp_getMDF_URL(uint8_t idx) { return vscp_deviceURL[idx]; }
...
uint8_t vscp_getBootLoaderAlgorithm(void) { return VSCP_BOOTLOADER_PIC1; }
...
uint8_t vscp_getNickname(void) { return readEEPROM(VSCP_EEPROM_NICKNAME); }
...
uint8_t vscp_getSegmentCRC(void) { return readEEPROM(VSCP_EEPROM_SEGMENT_CRC); }
...
uint8_t vscp_getControlByte(void) { return readEEPROM(VSCP_EEPROM_CONTROL); }
...
int8_t sendVSCPFrame(uint16_t vscpclass, uint8_t vscptype, uint8_t nodeid,
  ...
  uint32_t id = ((uint32_t)priority << 26) | ((uint32_t)vscpclass << 16) |
                ((uint32_t)vscptype << 8) | nodeid; // nodeaddress (our address)
...
int8_t getCANFrame(uint32_t *pid, uint8_t *pdlc, uint8_t *pdata) {
  ...
  if (vscp18f_readMsg(pid, pdata, pdlc, &flags)) {
    ...
    // RTR not interesting
    if (flags & CAN_RX_RTR_FRAME)
      return FALSE;

    // Must be extended frame
    if (!(flags & CAN_RX_XTD_FRAME))
      return FALSE;
